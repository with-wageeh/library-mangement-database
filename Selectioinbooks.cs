...
{
    public partial class Selectioinbooks : Form
    {
        private readonly SqlConnection conn;
        string user;
        public Selectioinbooks(SqlConnection conn, string username)
        {
            InitializeComponent();
            user = username;
            this.conn = conn;
        ...
        private void Selectioinbooks_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO booked (member_id, book_id, date) VALUES (@id, @id_book, @cur_date);";
            ...
            string updateQuery = "UPDATE books SET number_of_additions = number_of_additions - 1, booked = booked + 1 WHERE id = @id_book;";
